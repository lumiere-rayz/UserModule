...
{
    public abstract class UserModuleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UserModuleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UserModuleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UserModuleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UserModuleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UserModuleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UserModuleDbContext, Task<T>> func)
        {
            T result;
